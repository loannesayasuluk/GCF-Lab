      ...
      <main className="w-full max-w-none lg:max-w-screen-2xl mx-auto px-2 sm:px-4 md:px-10 lg:px-16 py-2 sm:py-8 overflow-x-hidden pb-20 mobile-optimized">
        ...
        {(currentView === "map" || !currentView) && (
          <div className="mb-2 space-y-2 mobile-padding">
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="flex-1">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-8 h-9 text-sm mobile-optimized"
              ...
              <Button onClick={handleSearch} className="bg-blue-600 hover:bg-blue-700 h-9 px-3 text-sm mobile-optimized">
                검색
              </Button>
            </div>
            {/* 필터 */}
            <div className="flex flex-wrap gap-1 mobile-margin">
              <Select value={filters.type} onValueChange={(value: Filters['type']) => setFilters(prev => ({ ...prev, type: value }))}>
                <SelectTrigger className="w-24 h-8 text-xs mobile-optimized">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
        ...
        {currentView === "map" && (
          <div className="flex flex-col gap-2 pb-20 sm:pb-0">
            {/* 지도 영역 */}
            <Card className="h-[260px] sm:h-[600px] lg:h-[700px] relative z-0 mobile-optimized mb-2">
              ...
              <CardContent className="p-0 relative z-0" style={{ minHeight: '160px' }}>
                <SimpleMap
            ...
            <Card className="mobile-optimized mb-2">
              <CardHeader className="pb-2">
            ...
            {/* 최근 제보 */}
            <Card className="mobile-optimized mb-0">
              <CardHeader className="pb-2">
